#' Add fluoresence deviation due to injection
#'
#' @param plate_layout a data frame generated by \code{seed_plate}
#' @param num.injections the number of injections in the Seahorse XF analysis
#'
#' @import dplyr
#' @import tibble
#' @import purrr
...
add_fluoresence_deviation_injection <- function(plate_layout, num.injections = 4) {
    ...
    measurement_injection <- tibble(Measurement = 1:15, 
